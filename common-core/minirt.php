		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				...
				<div class="p-0 scale-introduction dancer from-down" id="introduction-21685">
					...
					<p>
                  Please respect the following rules:<br><br>- Remain polite, courteous, respectful and constructive<br>
                  throughout the evaluation process. The well-being of the community<br> depends on it.<br><br>-
                  Identify with the person (or the group) evaluated the eventual<br> dysfunctions of the work. Take the
                  time to discuss<br> and debate the problems you have identified.<br><br>- You must consider that there
                  might be some difference in how your<br> peers might have understood the project's instructions and
                  the<br> scope of its functionalities. Always keep an open mind and grade<br> him/her as honestly as
                  possible. The pedagogy is valid only and<br> only if peer-evaluation is conducted seriously.<br>
                </p>
				</div>
				<div class="p-0 scale-guidelines dancer from-down" id="guidelines-21685">
                  ...
                  no malicious aliases was used to fool you<br> and make you evaluate something other than the content
                  of the<br> official repository.<br><br>- To avoid any surprises, carefully check that both the
                  evaluating<br> and the evaluated students have reviewed the possible scripts used<br> to facilitate
                  the grading.<br><br>- If the evaluating student has not completed that particular<br> project yet, it
                  is mandatory for this student to read the<br> entire subject prior to starting the defence.<br><br>-
                  Use the flags available on this scale to signal an empty repository,<br> non-functioning program, a
                  norm error, cheating etc. In these cases,<br> the grading is over and the final grade is 0 (or -42 in
                  case of<br> cheating). However, with the exception of cheating, you are<br> encouraged to continue to
                  discuss your work (even if you have not<br> finished it) in order to identify any issues that may have
                  ...
                  want to edit a file, take the time to explicit the reasons with the <br> evaluated student and make
                  sure both of you are okay with this.<br><br>- You must also verify the absence of memory leaks. Any
                  memory allocated on the heap must<br> be properly freed before the end of execution.<br> You are
                  allowed to use any of the different tools available on the computer, such as<br> leaks, valgrind, or
                  e_fence. In case of memory leaks, tick the appropriate flag.<br>
                </p>
				</div>
				<hr>
					...
					<div class="project-attachments-list">
						<div class="project-attachment-item">
							<h4 class="attachment-name">
								...
								<span class="icon-file"></span>
								<a target="_blank" href="https://github.com/romanmikh/42-Subjects/"
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					...
					<section class="scale-section-item dancer from-down" id="section-70028">
						...
						<ul>
							...
							<li>Handle bump map textures<?php echo PATH; ?>li>
						</ul>
